...
function switchTab(el, name) {
    ...
    if (cleanName === '표지') {
        ...
        setTimeout(() => document.getElementById('c2').classList.add('animate'), 300);
        setTimeout(() => document.getElementById('c3').classList.add('animate'), 500);
    } 
    ...
    box.style.animation = 'charFade 0.5s ease-out';
}
